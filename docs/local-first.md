...
<!-- antes: a documentação possuía apenas um marcador GOS3 e uma regra operacional no cabeçalho. -->
<!-- depois: a documentação passa a carregar a proveniência GOS3 completa sem misturar regra operacional ao contrato do header. -->
