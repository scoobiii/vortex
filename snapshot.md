# Git log
```
3ffbdc9 Merge pull request #65 from scoobiii/feat/mcp-agent-sovereignty-contract
f21deef Merge branch 'main' into feat/mcp-agent-sovereignty-contract
b191199 Merge pull request #66 from scoobiii/docs/official-spec-mcp-gateway-bootstrap-vua
0305b92 Merge branch 'main' into docs/official-spec-mcp-gateway-bootstrap-vua
...
70a00b9 docs: define Vortex MCP Gateway foundation spec
48704d8 test: add MCP agent authority contract test
676e997 test: enforce MCP agent authority contract
...
## docs/VORTEX-GATEWAY-MCP-AGENT-CONTRACT.md
```.md
# GOS3
...
## docs/VORTEX-MCP-GATEWAY-FOUNDATION-SPEC.md
```.md
# GOS3
...
```.json
{
  ...
  "scripts": {
    ...
    "test:mcp:agent-authority": "ts-node tests/mcp-agent-authority.test.ts"
  },
