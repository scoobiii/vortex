...
const ok: SandboxResult = {
  status: "success", stdout: "qwen-ok", stderr: "", exit_code: 0, duration_ms: 2,
  runtime_id: "rt-test", execution_id: "exec-test", evidence_hash: "hash-ok"
};
const fail: SandboxResult = {
  status: "error", stdout: "", stderr: "worker failed", exit_code: 1, duration_ms: 2,
  runtime_id: "rt-test", execution_id: "exec-test-2", evidence_hash: "hash-fail"
};
